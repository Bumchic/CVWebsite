...
import DevPic from '../Image/3DevHandRecogProject.jpg'
import Chess from '../Image/ChineseChess3.png'
import CSign from '../Image/CSign.png'
import pixelworld from '../Image/PixelWorld.png'
                  ...
                  <div className='container d-flex justify-content-start'>
                    <div className='row'>
                      <div className='col position-relative'>
                        <motion.img layout src={DevPic} className='d-block showpic h-100 img-fluid' onHoverStart={() => { settextvisible(true) }}
                      ...
                      <div className='col position-relative'>
                        <motion.img layout src={CSign} className='d-block showpic h-100 img-fluid' onHoverStart={() => { settextvisible1(true) }}
              ...
              <div className='row'>
                ...
                <div className='col'>
                  <div className='container d-flex justify-content-start'>
                    <div className='row'>
                      <div className='col position-relative'>
                        <motion.img layout src={Chess} className='showpic h-100 img-fluid' onHoverStart={() => { settextvisible2(true) }}
              ...
              <div className='row'>
                ...
                <div className='col'>
                  <div className='container d-flex justify-content-start'>
                    <div className='row'>
                      <div className='col position-relative'>
                        <motion.img layout src={pixelworld} className='d-block showpic h-100 img-fluid' onHoverStart={() => { settextvisible3(true) }}
